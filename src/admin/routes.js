...
const InitLocalStorageSettings = (props) => {
    ...
    return (
        <InitDataBaseSettingsWithHoc
            atrcStore={PortfolioManagerLocalize.store}//store from AtrcRegisterStore
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const rootElement = document.getElementById(PortfolioManagerLocalize.root_id);
    ...
    if (rootElement) {
        ...
        render(
            <InitLocalStorageSettingsWithHoc
                atrcStore={PortfolioManagerLocalize.store} //store from AtrcRegisterStore
                atrcStoreKey='PortfolioManagerLocal'//key from admin.js
            />,
            rootElement
        );
    }

...
const MainContent = () => {
    ...
    return (
        <AtrcContent>
            ...
            <AtrcPanelRow>
                <AtrcControlSelect
                    label={__('Setting 5 Select', 'portfolio-manager')}
                    value={setting5}
                    options={[
                        {
                            label: __('Option 1', 'portfolio-manager'),
                            value: 'option-1'
                        },
                        {
                            label: __('Option 2', 'portfolio-manager'),
                            value: 'option-2'
                        },
                    ]}
                    onChange={newVal =>
        ...
        <AtrcWireFrameHeaderContentFooter
            ...
            renderContent={
                <>
                    ...
                    <AtrcPanelBody
                        title={__('FAQ Query 4?', 'portfolio-manager')}
                        initialOpen={false}>
                        <AtrcText
                            tag='p'
                            className={classNames(AtrcPrefix('m-0'), 'at-m')}>

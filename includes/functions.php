...
if ( ! function_exists( 'portfolio_manager_default_options' ) ) :
	/**
...
if ( ! function_exists( 'portfolio_manager_get_options' ) ) :
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function portfolio_manager_get_options( $key = '' ) {
		$options = get_option( PORTFOLIO_MANAGER_OPTION_NAME );

		$default_options = portfolio_manager_default_options();
...
if ( ! function_exists( 'portfolio_manager_update_options' ) ) :
	/**
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function portfolio_manager_update_options( $key_or_data, $val = '' ) {
		if ( is_string( $key_or_data ) ) {
			$options                 = portfolio_manager_get_options();
...
if ( ! function_exists( 'portfolio_manager_parse_changelog' ) ) {
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function portfolio_manager_parse_changelog() {

		$wp_filesystem = portfolio_manager_file_system();

		$changelog_file = apply_filters( 'portfolio_manager_changelog_file', PORTFOLIO_MANAGER_PATH . 'readme.txt' );
...
if ( ! function_exists( 'portfolio_manager_get_white_label' ) ) :
	/**
	 ...
	 * @author     codersantosh <codersantosh@gmail.com>
	 */
	function portfolio_manager_get_white_label( $key = '' ) {
		$plugin_name = apply_filters(
			'portfolio_manager_white_label_plugin_name',
			esc_html__( 'WP React Plugin Boilerplate', 'portfolio-manager' )
		);

		$options = apply_filters(
			'portfolio_manager_white_label',
			array(
				'admin_menu_page' => array(
					'page_title' => esc_html__( 'ReactJs Settings Page', 'portfolio-manager' ),
					'menu_title' => esc_html__( 'ReactJs Settings', 'portfolio-manager' ),
					'menu_slug'  => PORTFOLIO_MANAGER_PLUGIN_NAME,
					'icon_url'   => PORTFOLIO_MANAGER_URL . 'assets/img/logo-20-20.png',
					'position'   => null,
				),
				'dashboard'       => array(
					'logo'   => PORTFOLIO_MANAGER_URL . 'assets/img/logo.png',
					'notice' => sprintf(
				...
				'landingPage'     => array(
					'banner'        => array(
						...
						'buttons'    => array(
							array(
								...
								'text'    => esc_html__( 'Get started', 'portfolio-manager' ),
								'url'     => 'https://github.com/prativagautam/portfolio-manager',
								'variant' => 'primary',
							),
							array(
								...
								'text'    => esc_html__( 'Docmentation', 'portfolio-manager' ),
								'url'     => 'https://github.com/prativagautam/portfolio-manager',
							...
							array(
								...
								'text'    => esc_html__( 'Get support', 'portfolio-manager' ),
								'url'     => 'https://github.com/prativagautam/portfolio-manager',
								'variant' => 'secondary',

							),
						),
						'image'      => PORTFOLIO_MANAGER_URL . 'assets/img/featured-image.png',
					...
					'identity'      => array(
						...
						'buttons' => array(
							array(
								'text'    => esc_html__( 'Visit site', 'portfolio-manager' ),
								'url'     => 'https://github.com/prativagautam/portfolio-manager',
								'variant' => 'primary',
							),
							array(
					...
					'contact'       => array(
						'title'  => esc_html__( 'Contact Information', 'portfolio-manager' ),
						'info'   => array(
							array(
								...
								'title'   => esc_html__( 'Support', 'portfolio-manager' ),
								'text'    => esc_html__( 'Get Support', 'portfolio-manager' ),
								'url'     => 'https://github.com/prativagautam/portfolio-manager',
								'variant' => 'link',
							),
							array(
								...
								'title'   => esc_html__( 'Email', 'portfolio-manager' ),
								'text'    => esc_html__( 'codersantosh@gmail.com', 'portfolio-manager' ),
							...
							array(
								...
								'title' => esc_html__( 'Location', 'portfolio-manager' ),
								'text'  => esc_html__( 'Kathmandu, Nepal', 'portfolio-manager' ),
							),
						),
						'social' => array(
							array(
							...
							array(
								...
								'url'     => 'https://github.com/prativagautam',
								'variant' => 'outline-primary',
							),
							array(
					...
					'bannerColumns' => array(
						array(
							...
							'title' => esc_html__( 'Activate Plugin', 'portfolio-manager' ),
						),
						array(
							...
							'title' => esc_html__( 'Login settings', 'portfolio-manager' ),
						),
						array(
							...
							'title' => esc_html__( 'Dashboard settings', 'portfolio-manager' ),
						),
					),
					'normalColumns' => array(
						array(
							...
							'title'      => esc_html__( 'Knowledge base', 'portfolio-manager' ),
							'content'    => esc_html__(
								'The utilization of this plugin can be facilitated by perusing comprehensive and well-documented articles.',
								'portfolio-manager'
							),
							'buttonText' => esc_html__( 'Visit knowledge base', 'portfolio-manager' ),
							'buttonLink' => 'https://github.com/prativagautam/portfolio-manager',

						),
						array(
							'icon'       => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="at-svg" viewBox="0 0 16 16"><path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/><path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6m0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5"/></svg>',
							'title'      => esc_html__( 'Community', 'portfolio-manager' ),
							'content'    => sprintf(
							/* translators: %s is the plugin name */
								esc_html__(
							...
							'buttonText' => esc_html__( 'Visit community page', 'portfolio-manager' ),
							'buttonLink' => 'https://github.com/prativagautam/portfolio-manager',
						),
						array(
							...
							'title'      => esc_html__( '24x7 support', 'portfolio-manager' ),
							'content'    => sprintf(
							/* translators: %s is the plugin name */
								esc_html__(
							...
							'buttonText' => esc_html__( 'Create a support thread', 'portfolio-manager' ),
							'buttonLink' => 'https://github.com/prativagautam/portfolio-manager',
						...
						array(
							...
							'title'      => esc_html__( 'Video guide', 'portfolio-manager' ),
							'content'    => sprintf(
							/* translators: %s is the plugin name */
								esc_html__(
							...
							'buttonText' => esc_html__( 'View video guide', 'portfolio-manager' ),
							'buttonLink' => 'https://github.com/prativagautam/portfolio-manager',
					...
					'topicLinks'    => array(
						...
						'title'   => esc_html__( 'Quick links to settings', 'portfolio-manager' ),
						'columns' => array(
							array(
								'icon'    => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="at-svg" viewBox="0 0 16 16"><path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/></svg>',
								'title'   => esc_html__( 'Settings 1', 'portfolio-manager' ),
							...
							array(
								'icon'    => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="at-svg" viewBox="0 0 16 16"><path d="M1 2.828c.885-.37 2.154-.769 3.388-.893 1.33-.134 2.458.063 3.112.752v9.746c-.935-.53-2.12-.603-3.213-.493-1.18.12-2.37.461-3.287.811zm7.5-.141c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/></svg>',
								'title'   => esc_html__( 'Advanced settings', 'portfolio-manager' ),
					...
					'changelog'     => array(
						...
						'title'   => esc_html__( 'Changelog', 'portfolio-manager' ),
						'content' => portfolio_manager_parse_changelog(),
					),
				),
			)
		);

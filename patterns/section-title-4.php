 ...
 * Slug: theme-lab/section-title-4
...
<h2 class="wp-block-heading has-text-align-center has-default-color has-text-color has-x-large-font-size" style="margin-bottom:var(--wp--preset--spacing--10);font-style:normal;font-weight:700"><?php esc_html_e( 'Try it now !', 'theme-lab' ); ?></h2>
<!-- /wp:heading -->

...
<!-- wp:pattern {"slug":"theme-lab/section-title-4"} /-->
...
<p class="has-default-color has-text-color has-x-large-font-size" style="margin-top:0px;margin-bottom:0px;font-style:normal;font-weight:600;line-height:1"><?php esc_html_e( 'We are available to take the next project with full energy', 'theme-lab' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<h6 class="wp-block-heading has-default-color has-text-color" style="font-size:16px"><?php esc_html_e( 'Quick Links', 'theme-lab' ); ?></h6>
<!-- /wp:heading -->
...
<!-- wp:navigation {"textColor":"tertiary","overlayMenu":"never","layout":{"type":"flex","orientation":"vertical"},"style":{"typography":{"fontSize":"13px"},"spacing":{"blockGap":"15px"}}} -->
	<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Blog', 'theme-lab' ); ?>","url":"#"} /-->

	<!-- wp:navigation-link {"label":"<?php esc_html_e( 'About', 'theme-lab' ); ?>","url":"#"} /-->

	<!-- wp:navigation-link {"label":"<?php esc_html_e( 'FAQs', 'theme-lab' ); ?>","url":"#"} /-->

	<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Authors', 'theme-lab' ); ?>","url":"#"} /-->
<!-- /wp:navigation --></div>
<!-- /wp:column -->
...
<!-- wp:column {"width":"20%","style":{"spacing":{"blockGap":"var:preset|spacing|20"}}} -->
<div class="wp-block-column" style="flex-basis:20%"><!-- wp:heading {"level":6,"style":{"typography":{"fontSize":"16px"}},"textColor":"default"} -->
<h6 class="wp-block-heading has-default-color has-text-color" style="font-size:16px"><?php esc_html_e( 'Contact', 'theme-lab' ); ?></h6>
<!-- /wp:heading -->
...
<div class="wp-block-group">
	...
	<p class="pwp-txt-dec-non has-tertiary-color has-text-color has-link-color" style="margin-top:0px;margin-bottom:0px"><a href="<?php echo esc_url( 'callto:000 - 9874 563 210' ); ?>"><?php esc_html_e( '000 - 9874 563 210', 'theme-lab' ); ?></a></p>
	<!-- /wp:paragraph -->

	<!-- wp:paragraph {"className":"pwp-txt-dec-non","style":{"elements":{"link":{"color":{"text":"var:preset|color|tertiary"},":hover":{"color":{"text":"var:preset|color|primary"}}}},"spacing":{"margin":{"top":"0px","bottom":"0px"}}},"textColor":"tertiary"} -->
	<p class="pwp-txt-dec-non has-tertiary-color has-text-color has-link-color" style="margin-top:0px;margin-bottom:0px"><a href="<?php echo esc_url( 'mailto:codersantosh@gmail.com' ); ?>"><?php esc_html_e( 'codersantosh@gmail.com', 'theme-lab' ); ?></a></p>
	<!-- /wp:paragraph -->
...
<!-- /wp:columns -->
 ...
 <!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"bottom":"var:preset|spacing|40"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between"}} -->
    ...
    <!-- wp:navigation {"textColor":"tertiary","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|20"},"typography":{"fontSize":"13px"}}} -->
     	<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Privacy', 'theme-lab' ); ?>","url":"#"} /-->
	<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Policy', 'theme-lab' ); ?>","url":"#"} /-->
	<!-- wp:navigation-link {"label":"<?php esc_html_e( 'Terms & Conditions', 'theme-lab' ); ?>","url":"#"} /-->
<!-- /wp:navigation -->

<!-- wp:pattern {"slug":"theme-lab/copyright"} /-->

</div>
<!-- /wp:group -->

<!-- wp:pattern {"slug":"theme-lab/scroll-to-top-button"} /-->

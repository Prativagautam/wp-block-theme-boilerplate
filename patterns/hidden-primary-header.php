 ...
 * Slug: theme-lab/hidden-primary-header
 * Inserter: no
 *
 * @package    Theme_Lab
...
<p class="has-text-align-center has-default-color has-text-color" style="margin-top:0px;margin-bottom:0px"><strong><?php esc_html_e( 'Theme Lab : ', 'theme-lab' ); ?></strong><?php esc_html_e( 'Complete your website with millions of Patterns, Templates &amp; Many more.', 'theme-lab' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
    ...
    <div class="wp-block-group alignwide">
        ...
        <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" style="padding-top:var(--wp--preset--spacing--10);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--10);padding-left:var(--wp--preset--spacing--30)"><?php esc_html_e( 'Get Started', 'theme-lab' ); ?></a></div>
        <!-- /wp:button --></div>
        <!-- /wp:buttons -->
